...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse bs-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li><a class="navbar-button-sel" href="../news">News</a></li>
        ...
        <div class="container">
            <?php getFeed('http://bfgteamnews.blogspot.com/feeds/posts/default?alt=rss'); ?>
            <h1 style="cursor:pointer;" onclick="window.open('http://bfgteamnews.blogspot.com/')">older posts</h1>
        </div>
