...
<html>
    ...
    <body>
        ...
        <div class="container centered" style="color:red"><h1><strong>Applications are currently closed but will be open soon!</strong></h1></div>
        <div class="container centered"><h4><strong>Feel free to fill out the app, but it will not get looked at until apps are officially opened again</strong></h4></div>
		
        <div class="container home-break"></div>
		
        <div class="container centered">
            <iframe src="https://docs.google.com/forms/d/1hDUCJrD4BLy-32X2MAC_7cPmc03OsUOPN8IM0mnmYu0/viewform?embedded=true" style="width:100%; height:2500px; border:none;">Loading...</iframe>
        </div>  
